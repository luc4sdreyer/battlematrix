...
public class ChallengePortBindingStub extends org.apache.axis.client.Stub implements za.co.entelect.challenge.Challenge {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "game"));
        oper.setReturnClass(za.co.entelect.challenge.Game.class);
    ...
    public ChallengePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "action");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Action.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "base");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Base.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "blockEvent");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.BlockEvent.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "direction");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Direction.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "EndOfGameException");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.EndOfGameException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "events");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Events.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "game");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Game.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "NoBlameException");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.NoBlameException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "player");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Player.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "point");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Point.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "state");
            cachedSerQNames.add(qName);
            ...
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.StateArray.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "unit");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.Unit.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "unitEvent");
            cachedSerQNames.add(qName);
            cls = za.co.entelect.challenge.UnitEvent.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public za.co.entelect.challenge.Game getStatus() throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "getStatus"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (za.co.entelect.challenge.Game) _resp;
            } catch (java.lang.Exception _exception) {
                return (za.co.entelect.challenge.Game) org.apache.axis.utils.JavaUtils.convert(_resp, za.co.entelect.challenge.Game.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {arg0, arg1});
  ...
  throw axisFaultException;
    ...
    public za.co.entelect.challenge.Delta setAction(int arg0, za.co.entelect.challenge.Action arg1) throws java.rmi.RemoteException, za.co.entelect.challenge.EndOfGameException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://challenge.entelect.co.za/", "setAction"));
